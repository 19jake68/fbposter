...
if ( $adminOptions[ 'enableNUR' ] )
    ...
    <div>
        ...
        <tr><td title="Your Facebook numerical User-ID. Click to find out"><a href="http://findmyfbid.com/" target="_new">' . $lang['FB ID'] . '</a>: <td><input class="textbox" type=text name=suuid>
        <tr><tr>
